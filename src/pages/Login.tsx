    ...
    <Layout>
      ...
      <section className="relative py-24 px-4">
        <div className="container mx-auto text-center">
          <div className="inline-flex items-center px-4 py-2 bg-card/50 backdrop-blur-sm rounded-full border border-hymn-gold/30 mb-8">
            ...
            <span className="text-sm text-hymn-cyan font-medium">Secure Login Portal</span>
          </div>
          ...
          <p className="text-xl text-muted-foreground mb-12 max-w-2xl mx-auto">
            Sign in to your HymnRO account and continue your legendary adventure in Midgard.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-md">
          <Card className="border-hymn-gold/20 bg-card/50 backdrop-blur-sm">
            <CardHeader className="text-center">
              <div className="w-16 h-16 bg-gradient-gold rounded-full flex items-center justify-center mx-auto mb-4">
                <LogIn className="w-8 h-8 text-hymn-navy" />
              </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="text-center">
                <p className="text-sm text-muted-foreground">
                  ...
                  <Button variant="link" className="text-hymn-gold hover:text-hymn-glow-gold p-0">
          ...
          {/* Security Notice */}
          <Card className="mt-8 border-hymn-cyan/20 bg-card/50 backdrop-blur-sm">
